...
| User AI session hours | 14.0h | 60.3h | 106.6h | 106.6h |
| AI worker hours | 2.4h | 122.3h | 442.6h | 442.6h |
| AI concurrency hours | 26.3h | 283.6h | 848.3h | 848.3h |
| Interactive sessions | 47 | 364 | 1,340 | 1,340 |
| Worker sessions | 79 | 1,170 | 3,009 | 3,009 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 60,128 | 112.1M | 17.9M | 5,927.9M | $18,173.76 | $80,027.84 | $0.00 |
| claude-sonnet-4-6 | 197,452 | 249.1M | 52.6M | 13,151.6M | $7,899.74 | $35,509.34 | $21,927.38 |
| gpt-5.3-codex | 35,471 | 207.4M | 9.5M | 2,382.7M | $1,799.54 | $4,467.67 | $5,301.62 |
| gpt-5.4 | 13,660 | 78.1M | 3.9M | 847.9M | $506.18 | $1,589.87 | $1,977.01 |
...
| gpt-5.4-mini | 32 | 145K | 5K | 908K | $0.81 | $1.70 | $2.98 |
...
| **Total** | **310,347** | **681.6M** | **85.1M** | **22,480.3M** | **$28,399.34** | **$121,673.64** | **$30,036.43** |

_24,226.1M total tokens processed. 92.8% cache hit rate._

_$151,710.07 total saved ($121,673.64 caching + $30,036.43 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 175,660 | 112.2M | 53.6M | 15,203.3M | $28,515.14 | $205,245.52 | $0.00 |
| claude-opus-4-5 | 42,226 | 18K | 11.9M | 3,731.6M | $6,497.37 | $50,377.03 | $0.00 |
| claude-sonnet-4-6 | 204,601 | 262.5M | 54.6M | 13,170.5M | $5,559.31 | $35,560.61 | $22,237.32 |
| gpt-5.3-codex | 36,983 | 211.8M | 9.7M | 2,411.3M | $2,134.34 | $4,521.27 | $5,392.83 |
...
| claude-haiku-4-5 | 1,183 | 1K | 363K | 65.9M | $6.72 | $47.51 | $119.51 |
...
| claude-sonnet-4 | 126 | 234 | 10K | 2.0M | $0.76 | $5.55 | $3.08 |
...
| **Total** | **491,817** | **705.8M** | **145.1M** | **36,416.9M** | **$44,187.51** | **$299,561.70** | **$31,908.32** |

_38,860.4M total tokens processed. 93.7% cache hit rate._

_$331,470.02 total saved ($299,561.70 caching + $31,908.32 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-07 11:53 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
