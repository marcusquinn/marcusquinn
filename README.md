...
| User AI session hours | 1.9h | 28.4h | 104.2h | 995.4h |
| AI worker hours | 14.4h | 145.8h | 376.2h | 2742.1h |
| AI concurrency hours | 21.7h | 279.3h | 973.7h | 6,059.1h |
| Interactive sessions | 7 | 75 | 339 | 5,848 |
| Worker sessions | 10 | 86 | 341 | 13,497 |

_Screen time from macOS display events, snapshotted daily. *365-day extrapolated (accumulating real data)._

_User AI session hours are attended interactive time measured from gaps between AI responses and the next user message; AI concurrency hours include attended time, AI generation, and background workers._

_AI session 365-day totals cover 221 days of local assistant session history (not extrapolated)._

## AI Model Usage (last 30 days)

| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 89,932 | 441.4M | 16.3M | 7,628.1M | $3,394.28 | $20,595.91 | $15,430.28 |
| gpt-5.4-mini | 443 | 3.8M | 54K | 19.1M | $1.77 | $35.92 | $68.77 |
| **Total** | **90,375** | **445.3M** | **16.3M** | **7,647.2M** | **$3,396.05** | **$20,631.83** | **$15,499.04** |

_8,108.9M total tokens processed. 94.3% cache hit rate._

_$36,130.87 total saved ($20,631.83 caching + $15,499.04 model routing vs all-Opus)._
...
| gpt-5.5 | 244,440 | 1,195.1M | 46.5M | 21,466.2M | $9,287.28 | $57,958.95 | $42,893.81 |
...
| **Total** | **828,385** | **1,922.2M** | **261.1M** | **71,115.0M** | **$85,061.83** | **$422,754.24** | **$89,998.94** |

_75,307.1M total tokens processed. 94.4% cache hit rate._

_$512,753.18 total saved ($422,754.24 caching + $89,998.94 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-07 01:52 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
