...
| User AI session hours | 12.9h | 66.0h | 121.1h | 121.1h |
| AI worker hours | 0.9h | 116.2h | 381.9h | 381.9h |
| AI concurrency hours | 23.7h | 252.6h | 801.8h | 801.8h |
| Interactive sessions | 52 | 293 | 1,317 | 1,317 |
| Worker sessions | 6 | 1,114 | 2,636 | 2,636 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 53,383 | 112.1M | 16.3M | 5,463.4M | $16,975.66 | $73,756.45 | $0.00 |
...
| **Total** | **303,687** | **687.1M** | **83.2M** | **21,975.0M** | **$27,195.24** | **$115,241.96** | **$30,021.46** |

_23,703.3M total tokens processed. 92.7% cache hit rate._

_$145,263.42 total saved ($115,241.96 caching + $30,021.46 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 178,494 | 112.2M | 54.7M | 15,527.2M | $29,082.23 | $209,618.52 | $0.00 |
...
| **Total** | **495,146** | **706.5M** | **146.2M** | **36,764.8M** | **$44,766.91** | **$303,994.31** | **$31,949.38** |

_39,225.4M total tokens processed. 93.7% cache hit rate._

_$335,943.68 total saved ($303,994.31 caching + $31,949.38 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-08 16:21 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
